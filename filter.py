...
while (cam.isOpened()):
    ...
    for e in face_landmarks:
        ...
        head_filterr = cv2.resize(head, (132+(int(e['right_eye'][3][0]) - int(e['left_eye'][0][0])), (80+((int(e['left_eye'][4][1]) + int(e['left_eye'][5][1]))//2) - ((int(e['left_eye'][1][1]) + int(e['left_eye'][2][1]))//2))))
